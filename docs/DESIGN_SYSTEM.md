...
| Mode | Description | Visible Panels |
|------|-------------|----------------|
| `landscape` | Default mode | All 5 panels |
| `portrait` | Vertical layout | Projects, Composer, Profile |
| `single` | Fullscreen canvas | Composer only |
